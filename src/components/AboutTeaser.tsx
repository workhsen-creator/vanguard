...
const AboutTeaser = () => {
    return (
        <section className="relative py-32 md:py-48 px-6 md:px-20 overflow-hidden bg-secondary">
            ...
            <motion.div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] md:w-[700px] md:h-[700px] border border-background/[0.05] rounded-full pointer-events-none"
                animate={{ rotate: 360 }}
            ...
            <div className="max-w-[1400px] mx-auto relative z-10">
                ...
                <motion.p
                    ...
                    className="text-center text-background/60 text-base md:text-lg max-w-2xl mx-auto mb-14 font-light leading-relaxed"
                >
                ...
                >
                    <Link to="/about" onClick={() => window.scrollTo(0, 0)}>
                        <motion.button
                            className="group relative px-10 py-4 md:px-14 md:py-5 rounded-full border border-background/10 bg-background/[0.03] backdrop-blur-sm text-background text-sm md:text-base uppercase tracking-[0.3em] font-medium overflow-hidden cursor-pointer transition-all duration-500 hover:border-primary/40"
