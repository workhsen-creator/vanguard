    ...
    return (
        <section className="relative py-32 md:py-48 px-6 md:px-20 overflow-hidden bg-background">
            ...
            <div className="max-w-[1400px] mx-auto relative z-10">
                ...
                {/* Big headings based on user request (Contact page style) */}
                <motion.div
                ...
                >
                    <h2 className="text-3xl md:text-6xl lg:text-7xl font-bold leading-[1.15] tracking-tight text-white/90 uppercase">
                        Say Helloo and let’s <br className="hidden md:block" /> get started on
                    </h2>
                    <h2 className="text-3xl md:text-6xl lg:text-7xl font-bold leading-[1.15] tracking-tight uppercase mt-2">
                        <span className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary/80 drop-shadow-[0_0_20px_rgba(238,126,75,0.3)]">
                            your next project!
                        </span>
                    </h2>
                </motion.div>
                ...
                >
                    Get in touch with Vanguard for PR, communications, and brand strategy inquiries. We partner with ambitious brands.
                </motion.p>
